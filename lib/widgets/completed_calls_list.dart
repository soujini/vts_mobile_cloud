...
class _CompletedCallsList extends State<CompletedCallsList> {
  ...
  Widget _itemBuilder(context, completedCalls, index) {
    completedCalls.dispatchInstructions_string =
        completedCalls.dispatchInstructions_string.replaceAll("\\n", "\n");
        ...
        child: Column(children: <Widget>[
          index == 0
              ? Padding(
                  ...
                  child: Text("Total " + completedCalls.count.toString(),
                      style: TextStyle(
                          fontSize: 18,
...
//                                        header: new Text("Icon header"),
                        ...
                        FlatButton.icon(
                            onPressed: () {
                              if (completedCalls.wreckerDriver == null ||
                                  completedCalls.wreckerDriver == '' ||
                                  completedCalls.wreckerDriver == 0 ||
                                  completedCalls.towTruck == null ||
                                  completedCalls.towTruck == '' ||
                                  completedCalls.towTruck == 0) {
                      ...
                      Padding(
                          ...
                          child: (Column(children: <Widget>[
                            completedCalls.towReasonName != null &&
                                    completedCalls.towReasonName != ''
                      ...
                      Padding(
                          ...
                          child: (Column(children: <Widget>[
                            new Row(
                              children: <Widget>[
                                Text(
                                    (completedCalls.towedStreet != null
                      ...
                      completedCalls.towedToStreet != null &&
