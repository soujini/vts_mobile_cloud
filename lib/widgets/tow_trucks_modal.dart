  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('SELECT WRECKER TRUCK', style:TextStyle(fontSize:14, fontWeight: FontWeight.w600)),
                ...
                children: <Widget>[
                  TypeAheadFormField(
                    ...
                    suggestionsCallback: (pattern) async {
                      await Provider.of<TowTrucksVM>(context, listen:false).listMini(pattern);
                      return Provider.of<TowTrucksVM>(context, listen:false).towTrucks;
                    },
                    itemBuilder: (context, suggestion) {
                      return ListTile(
                          leading: Icon(Icons.directions_transit, size: 20, color:Colors.grey),
                          title: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Padding(
                                  padding: EdgeInsets.only(bottom: 15, top: 13),
                                  child: Text(suggestion.towTruckName, style:TextStyle(fontSize:14, fontWeight: FontWeight.w400))),
                              Padding(
