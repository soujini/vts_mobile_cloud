...
class UpdateStatus extends StatefulWidget {
  ...
  UpdateStatus(
      {Key key, this.selectedCall, this.userRole, this.dispatchPaging, this.notifyParent, this.fromPage});
...
class _UpdateStatusState extends State<UpdateStatus> {
  ...
  smsDriver(BuildContext context) async {
    await Provider.of<ProcessTowedVehiclesVM>(context, listen: false)
        .processDriverSMSMessage(widget.selectedCall.id);
...
//                    Navigator.of(context).pop();
  ...
  mobileDigitalDispatch(selectedStatus, mode) async {
  ...
  setStatus(String mode, bool moveStatus, String timeline) async{
...
//              ),
              ...
              Visibility(
                  visible: widget.selectedCall.dispatchStatusName ==
                      "Dispatch" ||
                      widget.selectedCall.dispatchStatusName == "Received" ||
                      widget.selectedCall.dispatchStatusName == "Enroute"
                      ? true
                      : false,
                  child: Padding(
                      padding: EdgeInsets.all(8.0),
                      child: SizedBox(
                          ...
                          height: 40,
                          child: FlatButton(
                              color: selectedStatus == "Dispatch" ? Color(
                                  0xff12406F) : Colors.white,
              ...
              Visibility(
                  visible: widget.selectedCall.dispatchStatusName ==
                      "Enroute" ||
                      widget.selectedCall.dispatchStatusName == "Dispatch" ||
                      widget.selectedCall.dispatchStatusName == "Onsite"
                      ? true
                      : false,
                  child: Padding(
                      padding: EdgeInsets.all(8.0),
                      child: SizedBox(
                          ...
                          height: 40,
                          child: FlatButton(
                              color: selectedStatus == "Enroute" ? Color(
                                  0xff12406F) : Colors.white,
              ...
              Visibility(
                  visible: widget.selectedCall.dispatchStatusName == "Onsite" ||
                      widget.selectedCall.dispatchStatusName == "Enroute" ||
                      widget.selectedCall.dispatchStatusName == "Rolling"
                      ? true
                      : false,
                  child: Padding(
                      padding: EdgeInsets.all(8.0),
                      child: SizedBox(
                          ...
                          height: 40,
                          child: FlatButton(
                              color: selectedStatus == "Onsite" ? Color(
                                  0xff12406F) : Colors.white,
              ...
              Visibility(
                  visible: widget.selectedCall.dispatchStatusName ==
                      "Rolling" ||
                      widget.selectedCall.dispatchStatusName == "Onsite" ||
                      widget.selectedCall.dispatchStatusName == "Arrived"
                      ? true
                      : false,
                  child: Padding(
                      padding: EdgeInsets.all(8.0),
                      child: SizedBox(
                          ...
                          height: 40,
                          child: FlatButton(
                              color: selectedStatus == "Rolling" ? Color(
                                  0xff12406F) : Colors.white,
              ...
              Visibility(
                  visible: widget.selectedCall.dispatchStatusName ==
                      "Arrived" ||
                      widget.selectedCall.dispatchStatusName == "Rolling" ||
                      widget.selectedCall.dispatchStatusName == "Cleared"
                      ? true
                      : false,
                  child: Padding(
                      padding: EdgeInsets.all(8.0),
                      child: SizedBox(
                          ...
                          height: 40,
                          child: FlatButton(
                              color: selectedStatus == "Arrived" ? Color(
                                  0xff12406F) : Colors.white,
              ...
              Visibility(
                  ...
                  child: Padding(
                      ...
                      child: SizedBox(
                          ...
                          height: 40,
                          child: FlatButton(
                              color: selectedStatus == "Cleared" ? Color(
                                  0xff12406F) : Colors.white,
...
//                                  color: Color(0xff6ACA25),
                                      ...
                                      splashColor: Colors.blueAccent,
                                      onPressed: () =>
                                      widget.selectedCall.dispatchStatusName ==
                                          "Arrived" && widget.userRole == "3"
                                          ? ''
                                          : checkStatus(),
                                      child: Align(
                                          alignment: Alignment
                                              .center,
                                          child: Text(widget.selectedCall
                                              .dispatchStatusName ==
                                              "Arrived" &&
                                              widget.userRole == "3"
                                              ? 'SET TO ARRIVED'
