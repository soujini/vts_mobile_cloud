  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('SELECT VEHICLE MAKE', style:TextStyle(fontSize:14, fontWeight: FontWeight.w600)),
                ...
                children: <Widget>[
                  TypeAheadFormField(
                    ...
                    suggestionsCallback: (pattern) async {
                      await Provider.of<VehicleMakesVM>(context, listen:false).listMini(pattern);
